...
class TestRoundTripSerialization:
    ...
    def test_complex_transcript_round_trip(self):
        ...
        transcript.add_action(MoveAction(
            turn=1, phase="movement", actor=actor1, distance_inches=6.0
        ))
        transcript.add_action(ShootAction(
            turn=1, phase="shooting", actor=actor2, target=target,
            weapon_name="Lascannon", shots=2, hits=1, wounds=1, damage_dealt=6
        ))
